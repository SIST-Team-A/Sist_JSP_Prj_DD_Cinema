	...
	<div id="wrap" >
		...
		<div id ="main" >
			...
			<div >
				...
				<div id="movie-select">
				<!-- 	<ul id = "movieList">
					<li id ="list1"  class ="test"  value="괴물"> 괴물 </li>
					<li id ="list2"  class ="test"  value="분노의질주"> 분노의질주 </li>
				...
				<%-- 	<ul id="dateList"style ="font-size: 15px">
					...
					<select id = "dateList" multiple class="form-control" style ="height : 100%; text-align :center" onchange="dateSelectBox()">
						...
						<%}else{ %>
 							<option style = "height : 30px" value = "<%=Month %>-<%=i%>"><%=i %>일</option>
						<%}// end if
				...
				<div id="movie-time">
					<select id="timeList" multiple class="form-control" style= " height:100%" onchange="timeSelectBox()">
						<option style = "height : 30px" value ="10:00">10:00 [잔여좌석 : 20]</option>
						<option style = "height : 30px" value ="14:00">14:00 [잔여좌석 : 20]</option>
						<option style = "height : 30px" value ="20:00">20:00 [잔여좌석 : 20]</option>
				...
				<div>
					...
					<a href = "seat.jsp"><input type="button" value ="좌석 선택" id="seatBtn"class="btn"/> </a>
				</div>
			</div>
