	...
	<script type="text/javascript">
		...
		$(function(){
			    ...
			    $("#addBtn").click(function(){
			    	...
			    	var endMovie = $("#endMovie").val().substring(2,4) * 365 + $("#endMovie").val().substring(5,7)* 30 + $("#endMovie").val().substring(8,10);
			        var  dateMovie = $("#dateMovie").val().substring(2,4) * 365 + $("#dateMovie").val().substring(5,7)* 30 + $("#dateMovie").val().substring(8,10);
